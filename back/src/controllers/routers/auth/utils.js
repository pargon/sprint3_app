...
function passport_callback(strategy_name, provider_user_id, provider_email, user_id, user_name, user_lastname) {
  ...
  if (user_id) {
    ...
    user = dbaccess.getUserByProvider(strategy_name, provider_user_id, provider_email, user_id);
    ...
    user = dbaccess.createUserByProvider(strategy_name, provider_user_id, provider_email, user_id, user_name, user_lastname);
